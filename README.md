...
## Пара слов про json-server

В задании необходимо было реализовать api на MSW, но я сделал через json-server для удобства проверки и тестирования. При использовании MSW после перезагрузки страницы все созданные мутации не сохранялись, так как MSW регистрируется при инициализации приложения и хранит данные in-memory.
